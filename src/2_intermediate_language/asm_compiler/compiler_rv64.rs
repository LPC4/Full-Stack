...
use crate::assembly_language::riscv::rv64i::{Lb, Ld, Lh, Lw, Sb, Sh, Sw};
...
impl CompilerRv64 {
    ...
    fn lower_index(
        ...
        dest: &crate::intermediate_language::IrRegister,
        ty: &IrType,
        base_ptr: &crate::intermediate_language::IrRegister,
        idx: &IrValue,
        ctx: &mut FunctionContext,
        alloc: &RegisterAllocator,
    ) {
    ...
    fn lower_call(
        &mut self,
        dest: &Option<crate::intermediate_language::IrRegister>,
        function: &str,
        args: &[IrValue],
        ctx: &mut FunctionContext,
        alloc: &RegisterAllocator,
