use crate::compiler::utility::diagnostics::Diagnostics;
use crate::compiler::utility::symbol_table::SymbolTable;
use crate::compiler::utility::type_context::TypeContext;
use crate::ir::values::{IrLabel, IrValue};
