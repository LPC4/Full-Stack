use asm_to_binary::assembler::directive::Directive;
use asm_to_binary::assembler::encode::encode;
use asm_to_binary::assembler::layout::compute_layout;
use asm_to_binary::assembler::parser::parse;
use asm_to_binary::assembler::reg_parse::{parse_float_reg, parse_int_reg};
use asm_to_binary::assembler::output::AssembledOutput;
use asm_to_binary::assembler::section::SectionKind;
use asm_to_binary::assembler::token::{AsmToken, BranchKind};
...
fn elf_export_uses_absolute_entry_point() {
    let output = AssembledOutput {
        sections: vec![asm_to_binary::assembler::section::SectionData {
