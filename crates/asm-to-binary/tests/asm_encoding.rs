...
fn rv64a_amos() {
    ...
    assert_enc!(
        AmoswapD::new(4, 5, 6).with_ordering(Ordering::aq()),
        0x0c62b22fu32
    );
    assert_enc!(
        AmoxorW::new(7, 8, 9).with_ordering(Ordering::aqrl()),
        0x269423afu32
    );
}
...
fn rv64a_lr_sc() {
    ...
    assert_enc!(
        Sc::w(12, 13, 14).with_ordering(Ordering::aq()),
        0x1ce6a62fu32
    );
    assert_enc!(
        Sc::d(0, 5, 4).with_ordering(Ordering::aqrl()),
        0x1e42b02fu32
    );
}
