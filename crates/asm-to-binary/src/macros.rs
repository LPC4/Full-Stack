...
macro_rules! r_inst {
    (
        ...
        pub struct $name {
            pub rd: crate::encode_decode::Reg,
            pub rs1: crate::encode_decode::Reg,
            pub rs2: crate::encode_decode::Reg,
        }

        impl $name {
            pub fn new(
                rd: crate::encode_decode::Reg,
                rs1: crate::encode_decode::Reg,
                rs2: crate::encode_decode::Reg,
            ) -> Self {
                Self { rd, rs1, rs2 }
            }
        }

        impl crate::traits::Instruction for $name {
            fn encode(&self) -> u32 {
                use crate::encode_decode::{RType, RiscvFormat};
                RType {
                    opcode: $opcode,
                    rd: self.rd,
                    funct3: $funct3,
...
macro_rules! i_imm_inst {
    (
        ...
        impl crate::traits::Instruction for $name {
            fn encode(&self) -> u32 {
                use crate::encode_decode::{IType, RiscvFormat};
                IType {
                    opcode: $opcode,
                    rd: self.rd,
                    funct3: $funct3,
...
macro_rules! i_load_inst {
    (
        ...
        pub struct $name {
            ...
            pub base: crate::encode_decode::Reg,
...
macro_rules! s_inst {
    (
        ...
        pub struct $name {
            ...
            pub src: crate::encode_decode::Reg,
            /// Byte offset added to `base`.
            pub offset: i32,
        }
        ...
        impl crate::traits::Instruction for $name {
            fn encode(&self) -> u32 {
                use crate::encode_decode::{RiscvFormat, SType};
                SType {
                    opcode: 0x23,
                    funct3: $funct3,
                    rs1: self.base,
...
macro_rules! b_inst {
    (
        ...
        impl crate::traits::Instruction for $name {
            fn encode(&self) -> u32 {
                use crate::encode_decode::{BType, RiscvFormat};
                BType {
                    opcode: 0x63,
                    funct3: $funct3,
                    rs1: self.rs1,
...
macro_rules! u_inst {
    (
        ...
        impl $name {
            pub fn new(rd: crate::encode_decode::Reg, imm: i32) -> Self {
                Self { rd, imm }
            }
        }
        ...
        impl crate::traits::Instruction for $name {
            fn encode(&self) -> u32 {
                use crate::encode_decode::{RiscvFormat, UType};
                UType {
                    opcode: $opcode,
                    rd: self.rd,
                    imm: self.imm,
...
macro_rules! j_inst {
    (
        ...
        impl $name {
            pub fn new(rd: crate::encode_decode::Reg, offset: i32) -> Self {
                assert!(
                    (offset & 1) == 0,
                    "{}: offset {} must be even",
                    $mnemonic,
        ...
        impl crate::traits::Instruction for $name {
            fn encode(&self) -> u32 {
                use crate::encode_decode::{JType, RiscvFormat};
                JType {
                    opcode: 0x6F,
                    rd: self.rd,
                    imm: self.offset,
